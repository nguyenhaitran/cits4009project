...
```
```{r}
total_deaths_by_country <- aggregate(. ~ Entity, data = countries_merged[, c("Entity","Region", 4:31)], sum)
...
we will aggregate the data of number of death of each death causes of each country. We will aggregate the total of death for each country over years for all death causes
