...
```
```{r}
eg1<-log1p(data$Outdoor_air_pollution)
boxplot(eg1)
```
...
ui <- fluidPage(
    ...
    selectInput("plot_type", "Select plot type:", choices = c("Line plot", "Heat map", "Correlation plot")),
    sidebarLayout(
        sidebarPanel(
            conditionalPanel(
...
Choose response and the feature variables. 
